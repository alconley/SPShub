...
To use spsevb, there is one key component a user must input the channel map ids on the Channel Map UI tab. The channel map provides the eventbuilders with information linking the CAEN digitizer board/channel numbers to detector types. 
