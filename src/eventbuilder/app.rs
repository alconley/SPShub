...
impl Default for EvbAppParams {
    fn default() -> Self {
        EvbAppParams { workspace: None, channel_map: None, scaler_list: None, shift_map: None, kinematics: KineParameters::default(), coincidence_window: 3.0e3, run_min: 0, run_max: 0 }
    }
}
